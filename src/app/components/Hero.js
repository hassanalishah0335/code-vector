    ...
    return (
        ...
        <div className=" relative h-[100vh] overflow-hidden " id='Home'>
            ...
            <div className='absolute inset-0 flex flex-col ml-[5%] sm:top-[30%] top-[40%] items-start'>
                <TypeAnimation sequence={["CodeVector Technologies", 1500, props.title, 2000, "Looking For A business Solution?", 2000, "Want to Develop A Website?", 2000]} wrapper="span" speed={20} repeat={Infinity} className='text-gray-100 font-semibold sm:w-[40%] text-4xl md:text-5xl lg:text-6xl xl:text-7xl sm:h-[50%] h-20' />
                <div className="flex">
